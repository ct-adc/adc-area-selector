(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ct-adc-area-selector"] = factory();
	else
		root["ct-adc-area-selector"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/rubyisapm/teamshare/adc-packages/area-selector/src/areaSelector.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] areaSelector.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e524ff2", Component.options)
  } else {
    hotAPI.reload("data-v-7e524ff2", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ct_utility__ = __webpack_require__(6);
        ...
        getArea: function getArea() {
            ...
            if (this.n === '全国') {
                ...
                if (readable) {
                    ...
                    if (areaArr.length > 0) {
                        return __WEBPACK_IMPORTED_MODULE_0_ct_utility___default.a.areaDataFormat.getAreaIdByName(areaArr.join(this.sep));
                    } else {
                        return '';
                    }
                }
...
// module
exports.push([module.i, "\n.area-select-container[data-v-7e524ff2] {\n    display: flex;\n    justify-content: space-between;\n}\n.area-select[data-v-7e524ff2] {\n    /*width: 25%;*/\n    display: inline-block;\n}\n", ""]);
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    var base = __webpack_require__(0),
        objTransfer = __webpack_require__(14),
        cookie = __webpack_require__(9),
        localStorage = __webpack_require__(13),
        sessionStorage = __webpack_require__(16),
        URIParser = __webpack_require__(7),
        numberFormat = __webpack_require__(1),
        dateFilter = __webpack_require__(11),
        areaDataFormat = __webpack_require__(8),
        INFO = __webpack_require__(12),
        scrollbar = __webpack_require__(15),
        coordinator=__webpack_require__(10);
  ...
  return _c('div', {
    ...
    on: {
      "change": function($event) {
        _vm.n = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
    ...
    on: {
      "change": function($event) {
        _vm.p = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
    ...
    on: {
      "change": function($event) {
        _vm.c = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
    ...
    on: {
      "change": function($event) {
        _vm.d = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7e524ff2", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7e524ff2&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./areaSelector.vue", function() {
			var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7e524ff2&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./areaSelector.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__areaSelector_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__areaSelector_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__areaSelector_vue__);
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "AreaSelector", function() { return __WEBPACK_IMPORTED_MODULE_0__areaSelector_vue___default.a; });
